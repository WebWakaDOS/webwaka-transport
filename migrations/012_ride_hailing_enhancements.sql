...
CREATE INDEX IF NOT EXISTS idx_active_drivers_operator ON active_drivers(operator_id);
...
CREATE INDEX IF NOT EXISTS idx_ride_requests_carpool ON ride_requests(carpool_group_id) WHERE carpool_group_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_ride_waypoints ON ride_waypoints(ride_request_id, sequence);
...
CREATE INDEX IF NOT EXISTS idx_surge_zone ON surge_snapshots(zone_id, created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_driver_verification_shift ON driver_verifications(driver_id, shift_date);
CREATE INDEX IF NOT EXISTS idx_driver_verification_driver ON driver_verifications(driver_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_daily_inspection ON daily_vehicle_inspections(vehicle_id, inspection_date);
CREATE INDEX IF NOT EXISTS idx_daily_inspection_operator ON daily_vehicle_inspections(operator_id);
...
CREATE INDEX IF NOT EXISTS idx_promo_operator ON promo_codes(operator_id);
...
CREATE TABLE IF NOT EXISTS promo_code_uses (
  ...
  ride_request_id TEXT REFERENCES ride_requests(id),
...
CREATE INDEX IF NOT EXISTS idx_tips_driver ON driver_tips(driver_id);
CREATE INDEX IF NOT EXISTS idx_tips_customer ON driver_tips(customer_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_driver_earnings_date ON driver_earnings(driver_id, date);
...
CREATE INDEX IF NOT EXISTS idx_lost_found_operator ON lost_found_items(operator_id);
CREATE INDEX IF NOT EXISTS idx_lost_found_trip ON lost_found_items(trip_id);
...
CREATE INDEX IF NOT EXISTS idx_ev_stations_city ON ev_charging_stations(city, status);
CREATE INDEX IF NOT EXISTS idx_ev_stations_operator ON ev_charging_stations(operator_id);
...
CREATE INDEX IF NOT EXISTS idx_toll_gates_route ON toll_gates(route_id);

-- ============================================================
-- WAIT TIME BILLING CONFIGURATION
-- ============================================================
CREATE TABLE IF NOT EXISTS wait_time_config (
  id TEXT PRIMARY KEY,
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_wait_config_operator ON wait_time_config(operator_id);
...
CREATE INDEX IF NOT EXISTS idx_carpool_status ON carpool_groups(status, departure_time);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_corporate_customer ON corporate_accounts(customer_id);
...
CREATE INDEX IF NOT EXISTS idx_corporate_invoices ON corporate_invoices(corporate_account_id, status);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_intercity_booking ON intercity_bookings(booking_id);

-- Extend trips with SOS fields if not present
ALTER TABLE trips ADD COLUMN sos_message TEXT;
ALTER TABLE trips ADD COLUMN sos_location_lat REAL;
ALTER TABLE trips ADD COLUMN sos_location_lng REAL;
